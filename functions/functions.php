...
function authentication(){
    ...
    if(filter_var($clean_email,FILTER_VALIDATE_EMAIL))
    {
        ...
        $rez=$db->query($upit);  // there was a error while registering, since there were no users, the $upit would return false.
        while($red=$db->fetch_assoc($rez))
        {
            if($clean_email!=$red['email'])
                                                            ...
                                                            if($password!="")
                                                                {
                                                                                    ...
                                                                                    while($red=$db->fetch_assoc($rez))
                                                                                        {
                                                                                            ...
                                                                                            if($username!=strtolower($red['username']))
                                                                                            {
                                                                                                ...
                                                                                                $upit="INSERT INTO users (username,email,password,gender) VALUES ('{$username}','{$email}', '{$password}', '{$gender}')";
                                                                                                $db->query($upit);
                                                                    ...
                                                                    //}
                                                                    //else echo "<p>This username ".$username." already exists.</p>";
                                                                }
                ...
                /*}
            else echo "<p>Email is already in use. Please enter another email adress.</p>";*/
        //}
    }
                                                    ...
                                                    if(strcspn($password, '+-,.!@#$&*^?')!=mb_strlen($password))
                                                        {   
                                                            ...
                                                            /*
                                                                        ...
                                                                        if(password_verify($password,$hashPwdDb))
                                                                            {
                                                                                ...
                                                                                else {echo "<p>Unknown email adress.Please try again.</p>"; exit();}
                                                                            }
                                                                ...
                                                                /*}
                                                            else echo "<p>Wrong password, please try again.</p>";*/
                                                        }
                                                    else echo "<p>Password must have some of special carracters +-,!#$&*^.</p>";
                                                }
                                            else echo "<p>Password can't contain any blank space.</p>";
